...
Estudante de front-end que faz sites mais bonitos do que precisa. Foco em UI limpa,
animações que têm propósito e código que alguém consegue ler depois.

Nas horas vagas provavelmente estou jogando Persona ou revendo Evangelion pela enésima
vez, e às vezes as duas coisas acabam vazando pro CSS.
...
| [studyos](https://github.com/pixelbarz/studyos) | Planner de estudos offline-first, PWA com IndexedDB | `LIVE` |
| [casatrigozero](https://github.com/pixelbarz/casatrigozero) | Landing page para cliente real | `LIVE` |
| [linksdobarz](https://github.com/pixelbarz/linksdobarz) | Página de links centralizada | `LIVE` |
...
![Top Languages](https://github-stats-extended.vercel.app/api?username=pixelbarz&rank_icon=github&custom_title=Meus%20status&show_icons=true&include_all_commits=true&theme=algolia)
